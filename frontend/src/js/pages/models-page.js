...
export function renderModelsPage() {
  return `
    ...
    <section class="page-section"><div class="container">
      ...
      <div class="table-wrap section-offset"><table class="table"><thead><tr><th>Model</th><th>Evidence</th><th>Confidence</th><th>Deployment</th></tr></thead><tbody><tr><td>TL-LSVM-TFIDF-v1.1.0-rc.1</td><td>Validation-only; Macro F1 0.5398</td><td>Unavailable</td><td>Not approved</td></tr><tr><td>Classical ensembles</td><td>Validation-only challenger comparison</td><td>No calibrated evidence</td><td>Not approved</td></tr><tr><td>Transformers</td><td>No completed artifact / metric</td><td>Not available</td><td>Not eligible</td></tr></tbody></table></div>
    </div></section>
  `;
}
