      ...
      <div class="container prediction-layout">
        ...
        <aside class="prediction-sidebar">
          <section class="result-card" data-result-card tabindex="-1" aria-labelledby="result-title" aria-busy="false">
            <p class="result-card__status"><span class="status-dot" data-result-status-dot></span><span data-result-status>Waiting for input</span></p>
            ...
            <div data-result-content hidden>
              <div class="result-card__header">
                ...
                <span class="result-label" data-result-prediction></span>
              </div>
              ...
              <section class="result-card__section">
                ...
                <div class="confidence-progress" data-confidence-progress data-status="unavailable" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" aria-valuetext="Not calibrated; decision score is not a probability."><span data-confidence-progress-fill></span></div>
